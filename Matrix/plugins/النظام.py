...
from . import sedub, BOTLOG, BOTLOG_CHATID, HEROKU_APP, mention, StartTime, zedversion
...
@sedub.zed_cmd(pattern="الانترنت(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
@sedub.zed_cmd(pattern="تاريخ التنصيب$")
