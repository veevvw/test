...
from . import sedub, make_gif, progress
...
@sedub.zed_cmd(pattern="ملصق متحرك(?: |$)(.*)")
...
@sedub.zed_cmd(pattern="ممتحركة(?: |$)((-)?(r|l|u|d|s|i)?)$")
...
@sedub.zed_cmd(pattern="متحرك ?([0-9.]+)?$")
async def _(event):
    reply = await event.get_reply_message()
