...
@sedub.zed_cmd(pattern="سبونج بوب")
async def kek(kek):
    await kek.edit(M)
...
@sedub.zed_cmd(pattern="ثعلب")
async def fox(fox):
    await fox.edit(F)


@sedub.zed_cmd(pattern="فيل")
async def elephant(elephant):
    await elephant.edit(E)


@sedub.zed_cmd(pattern="معصب")
async def homer(homer):
    await homer.edit(H)


@sedub.zed_cmd(pattern="خنزير")
async def pig(pig):
    await pig.edit(P)
...
@sedub.zed_cmd(pattern="معارض")
async def marth(marth):
    await marth.edit(L)



@sedub.zed_cmd(pattern="مروحيه(?: |$)(.*)")
async def _(event):
...
@sedub.zed_cmd(pattern="ابره(?:\\s|$)([\\s\\S]*)")
...
# Copyright (C) 2022 Zedthon . All Rights Reserved
@sedub.zed_cmd(pattern="تسليه2")
async def cmd(Matrixallll):
    await edit_or_reply(Matrixallll, Fun2_cmd)


@sedub.zed_cmd(pattern="غبي$")
async def _(event):
...
# Copyright (C) 2022 Zedthon . All Rights Reserved
@sedub.zed_cmd(pattern="تسليه3")
async def cmd(Matrixallll):
    await edit_or_reply(Matrixallll, Fun3_cmd)


@sedub.zed_cmd(pattern="نجمه$")
async def _(event):
...
@sedub.zed_cmd(pattern="النضام الشمسي$")
async def _(event):
    animation_interval = 0.1
...
@sedub.zed_cmd(pattern=f"موسيقى$")
async def _(event):
...
# Copyright (C) 2022 Zedthon . All Rights Reserved
@sedub.zed_cmd(pattern="تسليه4")
async def cmd(Matrixallll):
    await edit_or_reply(Matrixallll, Fun4_cmd)


@sedub.zed_cmd(pattern="رقص$")
async def _(event):
    event = await edit_or_reply(event, "👏.")
    deq = deque(list("👏💃👏💃👏💃👏💃"))
    for _ in range(48):
...
# Copyright (C) 2022 Zedthon . All Rights Reserved
@sedub.zed_cmd(pattern="تسليه5")
async def cmd(Matrixallll):
    await edit_or_reply(Matrixallll, Fun5_cmd)


@sedub.zed_cmd(pattern="ميت (.*)")
...
# Copyright (C) 2022 Zedthon . All Rights Reserved
@sedub.zed_cmd(pattern="تسليه6")
async def cmd(Matrixallll):
    await edit_or_reply(Matrixallll, Fun6_cmd)


@sedub.zed_cmd(pattern=r"تهكير$")
async def _(event):
...
@sedub.zed_cmd(pattern="احبك")
async def _(sedub):
    zzz = random.choice(love)
    return await edit_or_reply(sedub, zzz)
...
@sedub.zed_cmd(pattern="تسليه8")
async def cmd(Matrixallll):
    await edit_or_reply(Matrixallll, Fun8_cmd)


@sedub.zed_cmd(pattern="كرات( (.*)|$)")
async def _(event):
    animation_interval = 0.5
