...
@sedub.zed_cmd(pattern=r"اضف فار (.*)")
...
@sedub.zed_cmd(pattern="حذف فار(?:\\s|$)([\\s\\S]*)")
async def variable(event):
...
# Copyright (C) 2022 TepthonArabic . All Rights Reserved
@sedub.zed_cmd(pattern="جلب فار(?:\\s|$)([\\s\\S]*)")
...
# Copyright (C) 2022 TepthonArabic . All Rights Reserved
@sedub.zed_cmd(pattern="وقت(?:\\s|$)([\\s\\S]*)")
async def variable(event):
...
@sedub.zed_cmd(pattern="اضف صورة (الفحص|فحص) ?(.*)")
...
@sedub.zed_cmd(pattern="اضف صورة (الحمايه|الحماية) ?(.*)")
...
@sedub.zed_cmd(pattern="اضف صورة (الاوامر|اللوحة) ?(.*)")
async def Tepthon(event):
    reply = await event.get_reply_message()
    if reply and reply.media:
        input_str = event.pattern_match.group(1)
...
@sedub.zed_cmd(pattern="اضف صورة (البوت|بوت) ?(.*)")
async def Tepthon(event):
    reply = await event.get_reply_message()
    if reply and reply.media:
        input_str = event.pattern_match.group(1)
...
@sedub.zed_cmd(pattern="اضف صورة (الوقتي|التلقائي|وقتي|البروفايل) ?(.*)")
async def Tepthon(event):
    reply = await event.get_reply_message()
    if reply and reply.media:
        input_str = event.pattern_match.group(1)
...
# Copyright (C) 2022 Tepthon . All Rights Reserved
@sedub.zed_cmd(pattern="اوامر الفارات")
async def cmd(baqir):
    await edit_or_reply(baqir, bilalvp_cmd)

@sedub.zed_cmd(pattern="الفارات")
async def cmd(baqir):
    await edit_or_reply(baqir, bilalvp_cmd)

@sedub.zed_cmd(pattern="اوامر الوقت")
async def cmd(baqir):
    await edit_or_reply(baqir, bilaltz_cmd)

@sedub.zed_cmd(pattern="الوقت")
async def cmd(baqir):
    await edit_or_reply(baqir, bilaltz_cmd)
