...
@sedub.zed_cmd(pattern=f"{ADMZ}(?:\s|$)([\s\S]*)")
...
@sedub.zed_cmd(pattern="رفع مالك(?:\s|$)([\s\S]*)")
async def promote(event):
    chat = await event.get_chat()
    admin = chat.admin_rights
    creator = chat.creator
...
@sedub.zed_cmd(pattern="اخفاء(?:\s|$)([\s\S]*)")
async def promote(event):
    chat = await event.get_chat()
    admin = chat.admin_rights
    creator = chat.creator
...
@sedub.zed_cmd(pattern=f"{UNADMZ}(?:\s|$)([\s\S]*)")
...
@sedub.zed_cmd(pattern=f"{BANN}(?:\s|$)([\s\S]*)")
...
@sedub.zed_cmd(pattern=f"{UNBANN}(?:\s|$)([\s\S]*)")
...
@sedub.zed_cmd(pattern=f"{MUTE}(?:\s|$)([\s\S]*)")
...
@sedub.zed_cmd(pattern=f"{UNMUTE}(?:\s|$)([\s\S]*)")
...
@sedub.zed_cmd(pattern=f"{KICK}(?:\s|$)([\s\S]*)")
