...
@sedub.zed_cmd(pattern="تعبير مكرر$")
...
@sedub.zed_cmd(pattern="ايقاف التكرار ?(.*)")
...
@sedub.zed_cmd(pattern=f"{UNSPAM} ?(.*)")
async def spammer(event):
    reply = await event.get_reply_message()
    await event.delete()
    delgvar("spamwork")
