...
async def ge(user, event):
    ...
    return user_obj
########################################
@sedub.zed_cmd(pattern="رابط الحذف")
async def _(zed):
...
########################################
@sedub.zed_cmd(pattern="بوت الحذف")
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/VEEVVW) 🗑♻️𓆪\n**𓍹━─━─━─━──━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف¹  ↬** @LC6BOT\n**✵│بـوت الحـذف²  ↬** @DTeLebot")
#####################################
@sedub.zed_cmd(pattern="رفع جلب(?: |$)(.*)")
...
#########################################
@sedub.zed_cmd(pattern="رفع مرتي(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
######################################
@sedub.zed_cmd(pattern="رفع بكلبي(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
#####################################
@sedub.zed_cmd(pattern="رفع بقلبي(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
####################################
@sedub.zed_cmd(pattern="رفع قلبي(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
########################   Userbot ~ By: ########
@sedub.zed_cmd(pattern="رفع جريذي(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="(نسبه الحب|نسبة الحب)(?: |$)(.*)")
...
@sedub.zed_cmd(pattern="(نسبه الانوثة|نسبة الانوثه|نسبه الانوثه|نسبة الانوثة)(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="(نسبه الغباء|نسبة الغباء)(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="(نسبه الانحراف|نسبة الانحراف)(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="(نسبه المثليه|نسبة المثليه)(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="(نسبه النجاح|نسبة النجاح)(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="(نسبه الكراهية|نسبة الكراهيه|نسبه الكراهيه|نسبة الكراهية)(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="رفع حمار(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="رفع خروف(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="رفع حيوان(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="رفع بزون(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="رفع زباله(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="رفع منشئ(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="رفع مدير(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="رفع كواد(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="رفع مرتبط(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="رفع مرتبطه(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="رفع حبيبي(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="رفع خطيبتي(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="رفع صاكه(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@sedub.zed_cmd(pattern="رفع حاته(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
