...
from Matrix.helpers.utils import _zedutils
...
# BACK
@sedub.tgbot.on(CallbackQuery(pattern="fmback"))
@check_owner
...
# UP
@sedub.tgbot.on(CallbackQuery(pattern="fmup_(.*)"))
@check_owner
async def up(event):
...
# DOWN
@sedub.tgbot.on(CallbackQuery(pattern="fmdown_(.*)"))
@check_owner
...
# FORTH
@sedub.tgbot.on(CallbackQuery(pattern="fmforth_(.*)"))
@check_owner
...
# REMOVE
@sedub.tgbot.on(CallbackQuery(pattern="fmrem_(.*)"))
@check_owner
...
# SEND
@sedub.tgbot.on(CallbackQuery(pattern="fmsend"))
@check_owner
...
# CUT
@sedub.tgbot.on(CallbackQuery(pattern="fmcut_(.*)"))
@check_owner
async def cut(event):
...
# COPY
@sedub.tgbot.on(CallbackQuery(pattern="fmcopy_(.*)"))
@check_owner
...
# PASTE
@sedub.tgbot.on(CallbackQuery(pattern="fmpaste_(.*)"))
@check_owner
