...
keyboard = [
  ...
  [
    Button.url("𝗧𝗘𝗣𝗧𝗛𝗢𝗡™ 𓅛", "https://t.me/Matrix")
    ]
]
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply(i + "\n\n**- شكـرًا لـ استخدامـك سـورس ماتركس ❤️**", buttons=keyboard)
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("قنـاة السـورس", "https://t.me/Matrix")
        ]
    ]
