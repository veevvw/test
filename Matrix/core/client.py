        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\n--------بـدء تتبـع سجـل ماتركس 𝗧𝗲𝗽𝘁𝗵𝗼𝗻--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ماتركس 𝗧𝗲𝗽𝘁𝗵𝗼𝗻--------"
            ...
            if pattern is not None:
                ...
                if edited:
                    sedub.add_event_handler(func, events.MessageEdited(**kwargs))
                sedub.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار ماتركس 𝗧𝗲𝗽𝘁𝗵𝗼𝗻 ✘**\n\n "
                        link = "[ܓܢܘܒ](https://t.me/zxaax)"
            ...
            if edited is True:
                sedub.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                sedub.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
